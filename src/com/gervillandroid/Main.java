...
public class Main {
    ...
    private static final boolean TRUE = Boolean.parseBoolean(trueString.toLowerCase()); // helper used to add unused code without warnings
    ...
    private void changeToRandomInstrument() {
        ...
        int randomIdx = (int)(Math.random() * instruments.length);
